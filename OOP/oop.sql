...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2025 at 10:54 AM
...
(1, 'Ahmad Nur Romadhon', '32231018', 1);
...
INSERT INTO `mata_kuliah` (`id`, `nama_mk`, `kode_mk`, `sks`, `jurusan_id`) VALUES
(1, 'Web2', '1', 4, 1);
...
INSERT INTO `nilai` (`id`, `mahasiswa_id`, `mata_kuliah_id`, `nilai`, `semester`) VALUES
(1, 1, 1, 90.00, '4');
